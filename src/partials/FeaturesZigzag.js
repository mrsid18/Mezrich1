          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                <img className="max-w-full mx-auto md:max-w-none h-auto" src={require('../img/rocket-3.jpeg').default} width="540" height="405" alt="Features 01" />
              </div>
              {/* Content */}
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-3xl text-purple-600 mb-2">Drop #1</div>
                  <h3 className="h4 mb-3">10,000 NFT collection around The Antisocial Network book with rocket ship emoji art and rarity traits.  Mint will be .08 ETH via [TBD] site.</h3>
                  ...
                  <p className="text-xl text-gray-100 mb-4">Holders of the these genesis Mezrich NFTs will be entitled to level 1 access and benefits :</p>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">
                ...
                <div className="font-architects-daughter text-3xl text-purple-600 mb-2">Drop #2</div>
                  <h3 className="h4 mb-3">X# NFT collection around Bitcoin Billionaires book with art TBD but related to Bitcoin.  Free to genesis token holders, one per wallet, free to mint plus gas.  Targeting Dec timeframe. </h3>
                  <p className="text-xl text-gray-100 mb-4">Holders of at least one genesis and one Bitcoin Mezrich NFT will be entitled to level 2 access and benefits - level 2 access includes all of level 1 access/benefits plus these additional ones:  </p>
                  <ul className="text-lg text-gray-400 -mb-2">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h4 mb-3">10,000 NFT collection around Bringing Down the House with Vegas related artwork.  mint will be .08 eth via benmezrich.com site.   Targeting Feb 2022 timeframe</h3>
                  <p className="text-xl text-gray-100 mb-4">Holders of at least one of all three Mezrich NFTs will be entitled to level 3 access and benefits - level 3 access includes all of level 1 and 2 access/benefits plus these additional ones</p>
                  <ul className="text-lg text-gray-400 -mb-2">
